    ...
    "STS", "UTS", "MATHWORLD", "FIL1", "PE1", "NSTP1", "HIST"
        ...
        do
        {
          ...
          while(input == "b"){
            ...
            ArtsAndScience it = new ArtsAndScience(); it.Display();
          }
    ...
    "THESIS2", "COM420","CEL424"
      ...
      run.Rate = 1;
            ...
            Console.Write(@"
                                              ...
                                              =======================================================================================================================================================
                                                      ...
                                                      TYPE: B to Back - 
                                                                                                  ...
                                                                                                  C H O I C E :  
            ");
             run.Speak("Select your semester");
            Console.SetCursorPosition(patakilid - 61, Console.CursorTop - 1);
             choice = Console.ReadLine();
            ...
            if(choice == "B" || choice == "b"){
                     ...
                     Console.Beep(); 
                ArtsAndScience sc = new ArtsAndScience(); sc.Display(); 
            }
