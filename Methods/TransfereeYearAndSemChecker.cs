...
namespace Online_Enrollment_System{
  ...
  class Transferee_CheckStudentYearLvl:Parent{
      ...
      public ArtsAndScience ans = new ArtsAndScience();
        ...
        public static void KnowTheYear()
        {
          ...
          if(Online_Enrollment_System.TransfereePage.user_course == "BSIT"){
                  BSIT1();
          }

           if(Online_Enrollment_System.TransfereePage.user_course == "Education Elementary"){
                  ELEM();
          }

          if(Online_Enrollment_System.TransfereePage.user_course == "Education English"){
                  ENG();
          }


           if(Online_Enrollment_System.TransfereePage.user_course == "BSME"){
                  BSME1();
          }

            if(Online_Enrollment_System.TransfereePage.user_course == "BSCE"){
                  BSCE1();
          }

           if(Online_Enrollment_System.TransfereePage.user_course == "ARTS & SCIENCE"){
                  ANS();
          }
      ...
      run.Rate = 1;
          ...
          if(Online_Enrollment_System.TransfereePage.year_lvl == "1" && Online_Enrollment_System.TransfereePage.sem == "1"){
                    BSIT.FirstYear_SecondSem.EnlistSubjects();

          }

              if(Online_Enrollment_System.TransfereePage.year_lvl == "1" && Online_Enrollment_System.TransfereePage.sem == "2"){
           ...
           if(Online_Enrollment_System.TransfereePage.year_lvl == "2" && Online_Enrollment_System.TransfereePage.sem == "1"){
                      BSIT.SecondYear_SecondSem.EnlistSubjects();
          }

           if(Online_Enrollment_System.TransfereePage.year_lvl == "2" && Online_Enrollment_System.TransfereePage.sem == "2"){
           ...
           if(Online_Enrollment_System.TransfereePage.year_lvl == "3" && Online_Enrollment_System.TransfereePage.sem == "1"){
                     BSIT.ThirdYear_SecondSem.EnlistSubjects();
          }

          if(Online_Enrollment_System.TransfereePage.year_lvl == "3" && Online_Enrollment_System.TransfereePage.sem == "2"){
           ...
           if(Online_Enrollment_System.TransfereePage.year_lvl == "4" && Online_Enrollment_System.TransfereePage.sem == "1"){
                                    BSIT.FourthYear_SecondSem.EnlistSubjects();
          }

          if(Online_Enrollment_System.TransfereePage.year_lvl == "4" && Online_Enrollment_System.TransfereePage.sem == "2"){
